...
public class AddCompanyDialogTest extends BaseTest {
    ...
    private static final String COMPANY_NAME = "CompanyName%s".formatted(runId);
    private static final String EXISTING_COMPANY_NAME = "ExistingCompanyName%s".formatted(runId);
    private static final String COMPANY_TYPE = "CompanyType";

    Company company = new Company(
            "CompanyNameTest%s".formatted(runId), "", "Company Type Test",
