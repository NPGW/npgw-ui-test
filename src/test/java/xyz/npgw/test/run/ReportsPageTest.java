...
public class ReportsPageTest extends BaseTest {
    ...
    private static final String COMPANY_NAME = "Generate report%s".formatted(runId);
    private static final String MERCHANT_TITLE = "Generate report merchant%s".formatted(runId);
