...
public class SpecialUserDashboardPageTest extends BaseTest {
    ...
    protected void beforeClass() {
        ...
        //TODO - add created merchant to the user "testUser@email.com"
    }
    ...
    public void testNavigateToDashboardAfterLoginAsSpecialUser() {
    ...
    public void testErrorMessageForReversedDateRangeAsSpecialUser() {
        UserDashboardPage dashboardPage = new UserDashboardPage(getPage())
                .getSelectDateRange()
    ...
    public void testVisibleChartElementsAreDisplayedCorrectlyAsSpecialUser() {
        UserDashboardPage dashboardPage = new UserDashboardPage(getPage())
...
//        assertThat(dashboardPage.getCurrencyLegendLabels()).hasText(new String[]{"EUR", "USD"}); currently no currency
    ...
    public void testResetFilterAsSpecialUser() {
        UserDashboardPage dashboardPage = new UserDashboardPage(getPage())
                .getSelectBusinessUnit().selectBusinessUnit(BUSINESS_UNIT_FOR_TEST_RUN)
    ...
    public void testCheckMerchantIdAsSpecialUser() {
        UserDashboardPage dashboardPage = new UserDashboardPage(getPage())
                .getSelectBusinessUnit().selectBusinessUnit(BUSINESS_UNIT_FOR_TEST_RUN);
    ...
    public void testTransactionSummaryAsSpecialUser() {
    ...
    public void testTransactionSummaryMockAsSpecialUser() {
    ...
    protected void afterClass() {
        BusinessUnit.delete(getApiRequestContext(), COMPANY_NAME_FOR_TEST_RUN, businessUnit);
        super.afterClass();
    }
}
