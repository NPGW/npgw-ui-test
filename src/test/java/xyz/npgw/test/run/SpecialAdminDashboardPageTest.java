...
public class SpecialAdminDashboardPageTest extends BaseTest {
    ...
    public void testNavigateToDashboardAfterLoginAsSpecialAdmin() {
    ...
    public void testErrorMessageForReversedDateRangeAsSpecialAdmin() {
        AdminDashboardPage dashboardPage = new AdminDashboardPage(getPage())
                .getSelectDateRange()
    ...
    public void testVisibleChartElementsAreDisplayedCorrectlyAsSpecialAdmin() {
        AdminDashboardPage dashboardPage = new AdminDashboardPage(getPage())
...
//        assertThat(dashboardPage.getCurrencyLegendLabels()).hasText(new String[]{"EUR", "USD"}); currently no currency
    ...
    public void testResetFilterAsSpecialAdmin() {
        AdminDashboardPage dashboardPage = new AdminDashboardPage(getPage())
    ...
    public void testCheckMerchantIdAsSpecialAdmin() {
        AdminDashboardPage dashboardPage = new AdminDashboardPage(getPage())
                .getSelectBusinessUnit().selectBusinessUnit(MERCHANT_TITLE);
    ...
    public void testTransactionSummaryAsSpecialAdmin() {
    ...
    public void testTransactionSummaryMockAsSpecialAdmin() {
